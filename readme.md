This is just my startpage for my browser, feel free to use it wholesale, copy code, change it on a local version, whatever, it's under the gpl v3 though so make sure you obey that.
